...
import EstablishmentsView
  from '../EstablishmentsView.vue'
      ...
      global: {
        stubs: {
          ...
          EstablishmentFilters:
            EstablishmentFiltersStub,

          EstablishmentMap:
            EstablishmentMapStub,

          EstablishmentResults:
            EstablishmentResultsStub,
        },
      },
    }
  )
...
function getSearchCalls() {
  return mocks.get.mock.calls.filter(
    ([url]) =>
      url
      === '/search/establishments/'
  )
...
describe(
  ...
  () => {
    it(
      'loads restrictions, profile and establishments',
      async () => {
        const wrapper =
    ...
    it(
      'initially applies the food profile restrictions',
      async () => {
        const wrapper =
          await mountLoadedView()
    ...
    it(
      'updates the search term and reloads establishments',
      async () => {
        const wrapper =
          await mountLoadedView()
    ...
    it(
      'manually toggles a restriction and disables profile mode',
      async () => {
        const wrapper =
          await mountLoadedView()
    ...
    it(
      'restores profile restrictions without creating duplicates',
      async () => {
        const wrapper =
          await mountLoadedView()
    ...
    it(
      'selects a location on the map and includes it in the search',
      async () => {
        const wrapper =
          await mountLoadedView()
    ...
    it(
      'updates result ordering and reloads establishments',
      async () => {
        const wrapper =
          await mountLoadedView()
    ...
    it(
      'sends hovered establishment to the map and clears it on leave',
      async () => {
        const wrapper =
          await mountLoadedView()
    ...
    it(
      'navigates to establishment detail when a result is selected',
      async () => {
        const wrapper =
          await mountLoadedView()
    ...
    it(
      'also navigates to detail when an establishment is selected on the map',
      async () => {
        const wrapper =
          await mountLoadedView()
    ...
    it(
      'shows no establishments when the search request fails',
      async () => {
        const consoleSpy =
          vi.spyOn(
            console,
