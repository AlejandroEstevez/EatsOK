...
describe('LoginView', () => {
  ...
  it(
    'logs in with the entered credentials and redirects home',
    async () => {
      const wrapper =
        mountLogin()
  ...
  it(
    'passes rememberMe when the option is selected',
    async () => {
      const wrapper =
        mountLogin()
  ...
  it(
    'shows a specific message for invalid credentials',
    async () => {
  ...
  it(
    'shows a generic message when login fails for another reason',
    async () => {
      mocks.login.mockRejectedValueOnce(
        new Error(
          'Server error'
