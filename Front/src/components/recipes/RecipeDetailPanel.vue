      ...
      >
        <div class="recipe-detail-scroll">
          <button
            ...
            @click="emit('close')"
          >
            <span class="recipe-detail-back-arrow">
              ‹
            </span>
          ...
          <template v-else>
            ...
            <section class="recipe-detail-header">
              ...
              <p
                v-if="recipe.establishment_name"
                class="recipe-detail-establishment"
              >
                Receta asociada a
                <strong>
              ...
              <p
                ...
                class="recipe-detail-description"
              >
                {{ recipe.description }}
              </p>
            </section>
            ...
            <section
              v-if="recipe.adapted_restrictions?.length"
              class="recipe-detail-adapted"
            >
              <strong>
                Adaptado para:
              </strong>
              ...
              <div class="recipe-detail-badges">
                <span
                  v-for="
                    restriction
                    in recipe.adapted_restrictions
                  "
                  :key="restriction.id"
