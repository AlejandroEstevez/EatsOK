  ...
  <article class="recipe-card">
    ...
    <div class="recipe-card-content">
      ...
      <div class="recipe-card-meta">
        <span
          v-if="recipe.preparation_time !== null"
          class="recipe-card-meta-item"
        >
          <img
            :src="clockIcon"
            alt=""
            class="recipe-card-meta-icon"
          >
