...
describe(
  ...
  () => {
    it(
      'renders the current filter values',
      () => {
        const wrapper =
          mountFilters({
            search: 'pizza',
    ...
    it(
      'shows the profile toggle as active when the profile is enabled',
      () => {
        const wrapper =
          mountFilters({
            useProfile: true,
    ...
    it(
      'emits the opposite profile value when toggled',
      async () => {
        const wrapper =
          mountFilters({
            useProfile: true,
    ...
    it(
      'renders only the selected allergies and diets',
      () => {
        const wrapper =
          mountFilters({
            selectedRestrictions: [
    ...
    it(
      ...
      async () => {
        ...
        const modal =
          wrapper.find(
            '.restriction-selector-modal-stub'
          )
    ...
    it(
      'emits replacement restrictions and closes the selector after confirmation',
      async () => {
        const wrapper =
          mountFilters()
    ...
    it(
      'emits clear when filters are cleared',
      async () => {
        const wrapper =
          mountFilters()
